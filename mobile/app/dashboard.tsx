    ...
    <View style={{ flex: 1, backgroundColor: colors.pearl }}>
      ...
      >
        ...
        <View style={styles.statsRow}>
          <Pressable
            style={[styles.stat, { flexDirection: 'row', alignItems: 'center' }]}
            onPress={() => router.push('/praticien-documents-status' as any)}
          >
            <View style={{ flex: 1 }}>
              <Text style={styles.statV}>
                {profile ? `${profile.documents_stats.valide}/${profile.documents_stats.total}` : '—'}
              </Text>
              <Text style={styles.statL}>DOCUMENTS VALIDÉS</Text>
            </View>
