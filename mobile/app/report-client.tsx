...
const reasons = [
  { key: 'no_show', title: 'Absent sans prévenir', detail: 'Ne s\'est pas présenté à la séance réservée' },
  { key: 'behavior', title: 'Comportement inapproprié', detail: 'Pendant ou après une séance' },
  { key: 'off_platform', title: 'Tentative de paiement hors plateforme' },
...
export default function ReportClient() {
  ...
  const [picked, setPicked] = useState('no_show');
    ...
    return (
      <View style={{ flex: 1, backgroundColor: colors.pearl }}>
        ...
        <View style={styles.emptyWrap}>
          ...
          <Text style={styles.emptyTitle}>Choisissez un client</Text>
          <Text style={styles.emptyBody}>
            Ouvrez un rendez-vous pour signaler le client concerné à l'équipe de modération.
          </Text>
        </View>
      </View>
    );
