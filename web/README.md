...
The marketing **landing site** + full **admin back-office** for **GuériEnergies**, the French marketplace of verified energy-wellness practitioners (magnétisme, Reiki, hypnose, chamanisme…).
...
- **Design system** ported from the GuériEnergies mobile app: Cormorant Garamond + Outfit, aurora gradients, soft editorial palette.
