...
export function EventCard({ e }) {
  return (
    <Link href={`/evenement/${e.id}`} className="card card-hover" style={{ overflow: 'hidden', display: 'block' }}>
      <div className="aurora-dark grain" style={{ height: 160, padding: 18, display: 'flex', alignItems: 'flex-end', '--orb-1': e.tone === 'gold' ? '#E4C896' : e.tone === 'sage' ? '#B8D4C2' : e.tone === 'violet' ? '#C4B0E8' : '#A8C8E8' }}>
